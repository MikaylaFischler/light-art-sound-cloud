...
public:
	static enum strip_type { ROW_1_2, ROW_3_4, TOP } Type;
	static enum seg_o { COLUMN_POS, COLUMN_NEG, ROW_POS, ROW_NEG } SegmentOrientation;
	static enum zone { RIGHT, FRONT, LEFT, TOP } Zone;
	...
	void mapSegmentToZone(led_segment_t* segment, uint8_t row, uint8_t col, seg_o_t orientation);
